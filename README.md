...
The [masters-thesis](https://github.com/agi-lab/reserving-RNN/tree/masters-thesis) branch refers to previous work from the Master's 
...
As the name suggests, this file is responsible for simulating the datasets from [SPLICE](https://github.com/agi-lab/SPLICE) (Avanzi, Taylor & Wang, 2023)
and [SynthETIC](https://github.com/agi-lab/SynthETIC) (Avanzi, Taylor, Wang & Wong, 2020).
...
These jupyter notebooks rely on 'Functions.py'. This script contains all the functions and classes to be called from each of the model 
training notebooks.
